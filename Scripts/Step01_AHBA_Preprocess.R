...
source(paste(base.dir, '/Scripts/function_library.R', sep = ''))  # Source function library
...
atlas_key           <- read.table(paste(base.dir, '/Data/Yeo_JNeurophysiol11_SplitLabels/Yeo_JNeurophysiol11_SplitLabels/MNI152/7Networks_ColorLUT_freeview.txt', sep=''))
...
atlas_key           <- read.table(paste(base.dir, '/Data/Yeo_JNeurophysiol11_SplitLabels/Yeo_JNeurophysiol11_SplitLabels/MNI152/17Networks_ColorLUT_freeview.txt', sep=''))
colnames(atlas_key) <- c('ID','Name','R','G','B','A')
...
# ----------------
save(file=paste(base.dir, '/Output/RData/all_data_cere_net17.Rdata', sep=''), x=all_data)
# load(file=paste(base.dir, '/Output/RData/all_data_cere_net17.Rdata', sep=''))
