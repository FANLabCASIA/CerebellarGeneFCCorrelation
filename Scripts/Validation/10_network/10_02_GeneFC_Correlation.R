...
mdtb_names  <- read.csv(paste(base.dir, '/Data/MDTB_10network_names.CSV', sep = ''), header=FALSE)
...
name.out     <- paste(base.dir, '/Output/SupplementaryData/SUPPDATA_sheet21_Gene_geneList_net10.csv', sep = '') # same as generated in the cere script
...
write.csv(x=out.matrix, file=paste0(base.dir, '/Output/SupplementaryData/SUPPDATA_sheet20_Gene_diffExpr_net10.csv')) # same as generated in the cere script
# ---------------------------------------------
...
diag(avg.mat) <- 0
# png(file = paste(base.dir, '/Output/SupplementaryData/Validation/10_Network/corrplot_481genes_net10.png', sep = ''),
#     width = 3000, height = 3000, res = 300)
pdf(file = paste(base.dir, '/Output/SupplementaryData/Fig/Validation/corrplot_481genes_net10.pdf', sep = ''),
    width = 10, height = 10)
rownames(avg.mat)
...
pdf(file = paste(base.dir, "/Output/SupplementaryData/Fig/Validation/corrplot_fc_net10.pdf", sep=''),
    width = 10, height = 10)
...
write.csv(file = paste(base.dir, '/Output/SupplementaryData/SUPPDATA_sheet22_Gene_correlation_net10.csv', sep=''), x = avg.mat)
write.csv(file = paste(base.dir, '/Output/SupplementaryData/SUPPDATA_sheet23_FC_WithinCere_net10.csv', sep=''), x = plot.func)
# ---------------------------
